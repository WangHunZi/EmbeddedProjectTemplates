...
// LCD_RS//dc
#define LCD_RS_SET                                                             \
  HAL_GPIO_WritePin(LCD_WR_RS_GPIO_Port, LCD_WR_RS_Pin, GPIO_PIN_SET) // PC4
#define LCD_RS_RESET                                                           \
...
ST7735_IO_t st7735_pIO = {lcd_init,    NULL,         (int)NULL,    lcd_writereg,
...
static int32_t lcd_gettick(void) { return HAL_GetTick(); }
